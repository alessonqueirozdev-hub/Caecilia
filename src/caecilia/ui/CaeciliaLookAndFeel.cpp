...
#include "caecilia/ui/CaeciliaLookAndFeel.h"
...
CaeciliaLookAndFeel::CaeciliaLookAndFeel()
{
...
void CaeciliaLookAndFeel::refreshFromTheme(const Theme& theme)
{
