...
class CaeciliaLookAndFeel final : public juce::LookAndFeel_V4
{
public:
    CaeciliaLookAndFeel();
    ~CaeciliaLookAndFeel() override = default;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(CaeciliaLookAndFeel)
};
