...
signal chain. This module contributes to the pure `caecilia_core` static library
...
caecilia::dsp::FdnReverb reverb;
reverb.prepare(sampleRate, maxBlockFrames, /*numChannels*/ 2); // off-thread
reverb.setPreset(caecilia::dsp::ReverbPreset::Cathedral);      // RT-safe

// audio thread:
caecilia::core::AudioBlock block{channels, 2, frames};
