...
MIDI interpretation and the console control surface for Ceciliae. This module
...
It is part of the pure, JUCE-free `ceciliae_core` static library and is fully
