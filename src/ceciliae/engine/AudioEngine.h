...
// sub-namespace, e.g. dsp -> ceciliae::dsp), the engine module deliberately
// nests under core as ceciliae::core::engine. It is the real-time seam of the
...
// only). See src/ceciliae/engine/README.md ("Namespace — a recorded exception").
