...
#include "ceciliae/control/ControlCommand.h"
...
/// address space (`/ceciliae/<name-with-slashes>`) and the JSON-RPC method map
/// (`ceciliae.<name>`) are generated from, so all transports stay in lockstep.
struct OpcodeName
{
