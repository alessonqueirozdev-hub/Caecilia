# `ceciliae::registration` — The queryable registration brain

Registration is Ceciliae's clearest structural win. Where GrandOrgue and Aeolus
...
It is part of the pure, JUCE-free `ceciliae_core` static library. It runs
