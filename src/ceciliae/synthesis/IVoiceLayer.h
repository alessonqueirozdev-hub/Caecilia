 ...
 *
 * Realism in Ceciliae lives in composition: a voice is an AttackLayer spliced
 ...
 *        pure-sample voice), in Ceciliae's own proprietary sample format.
 *
 ...
 * resampler drives. Ceciliae prefers a loop-free modeled sustain, so
