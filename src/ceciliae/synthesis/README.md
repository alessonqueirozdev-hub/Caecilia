...
# ceciliae::synth — Synthesis module

Voice implementations behind the pure `ceciliae::core::IVoice` contract. This
module turns a keypress on a rank into audio, and it is where Ceciliae's core
...
- **`ceciliae_core`** (plus the C++ standard library) and the **`wind`** module,
