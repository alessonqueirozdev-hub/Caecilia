...
#include "ceciliae/tuning/DetuneCurve.h"
#include "ceciliae/tuning/StretchTuning.h"
 ...
 *   off the audio thread. The synthesis layer reads a stable TuningModel in
 *   prepare() and on such change commands, never mid-render.
