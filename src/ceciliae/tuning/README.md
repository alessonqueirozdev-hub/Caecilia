...
Historical temperaments and micro-tuning for Ceciliae. This module turns a chosen
...
JUCE-free `ceciliae_core` static library and is fully unit-testable headless.
