 ...
 */
class CeciliaeEditor final : public juce::AudioProcessorEditor,
                             private juce::Timer
{
public:
    explicit CeciliaeEditor(CeciliaeAudioProcessor& processor);
    ~CeciliaeEditor() override;
...
private:
    ...
    CeciliaeAudioProcessor& processor_;
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(CeciliaeEditor)
};
